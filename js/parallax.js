...
$(window).scroll(function(){
  ...
  $('.logo').css({
    'transform': 'translate(0px, '+ wScroll /5 +'%)' //przesunięcie diva w dół zraz z przesuwaniem strony, /2 - powoduje spowolnienie 0 połowę, + oznaczają że przesuwaja się o wartoś dodatnią
  });
